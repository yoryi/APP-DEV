...
render() {
    ...
    <Text style={{fontSize: Texto.titulo, color: Color.principal, textAlign: 'left',fontWeight:'bold'}}>Perfil</Text> 
    <Text style={{fontSize: Texto.nombre, color: Color.segundario, textAlign: 'left', marginTop: '-2%'}}></Text>  
    </View>
