...
render() {
    ...
    <Text style={{fontSize: Texto.titulo, color: Color.principal, textAlign: 'left',fontWeight:'bold'}}>Bienvenido!</Text> 
    <Text style={{fontSize: Texto.nombre, color: Color.segundario, textAlign: 'left', marginTop: '-2%'}}>Jorginho Ojeda</Text>  
    </View>

    <View style={styles.boton}>
    <TouchableOpacity onPress={() => Actions.Notificaciones()}>
    <Image source={Notificaciones} style={styles.icono}/>
    </TouchableOpacity>
    </View>
